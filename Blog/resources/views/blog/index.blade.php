         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-8 col-sm-12">
                  <div class="about_img"><img src="{{asset('assets/images/about-img.png')}}"></div>
               ...
               <div class="col-lg-4 col-sm-12">
                  <div class="image_5"><img src="{{asset('assets/images/img-5.png')}}"></div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            ...
            <div class="contact_menu">
               <ul>
                  <li><a href="#"><img src="{{asset('assets/images/call-icon.png')}}/"></a></li>
                  <li><a href="#">Call : +01 1234567890</a></li>
                  <li><a href="blog.html"><img src="{{asset('assets/images/mail-icon.png')}}"></a></li>
